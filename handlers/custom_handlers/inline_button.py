...
def change_show_foto(call: CallbackQuery) -> None:
    ...
    bot.edit_message_reply_markup(call.message.chat.id, call.message.id, reply_markup=main_menu_st2_keyboard(num, not foto))
...
def change_number_hotels(call: CallbackQuery) -> None:
    ...
    bot.edit_message_reply_markup(call.message.chat.id, call.message.id, reply_markup=main_menu_st2_keyboard(number_hotels=num, foto=foto))
